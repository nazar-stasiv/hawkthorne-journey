...
- provision  [[https://love2d.org/wiki/Category:Libraries][libraries]] with  luarocks to  save (see  src/vendor) about
  ...
  - inspect 1.2.1
  - tween 1.0.1
- fetch few others from github s.t. luarock is aware about it
  - TastyText  2.0
  - utf8.lua
- replace src/vendor/*.lua with luarocks
  - gamestate come from hump
  - timer come from hump
...
- also port to DIY [[https://lutro.libretro.com][consoles]]
* Game
